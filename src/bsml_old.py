...
def main(
    emp_model_path=".runs/detect/F_NAME/weights/best.pt",
    act_model_path=".runs/detect/fold-m/weights/best.pt",
    emp_classes=["Anjani", "Deti", "Dita", "Fifi", "Hutizah", "Nani", "Nina", "Sumi", "Tia", "Uji"],
    act_classes=["Working"],
    # video_path="rtsp://admin:oracle2015@192.168.100.6:554/Streaming/Channels/1",
    video_path="D:/SBHNL/Resources/Videos/sample.mp4",
    table_sql="empact",
    server=None,
    camera_id="FOLDING",
    mask_path=None,
...
main(
    mask_path=".runs/images/mask9.png",
    # server="10.5.0.3",
    interval_send=10,
    anto_time=300,
    show=True,
