...
# Mengambil dimensi frame untuk VideoWriter
ret, frame = ai_cctv.cap.read()
frame_height, frame_width = frame.shape[:2]
ai_cctv.cap.set(cv2.CAP_PROP_POS_FRAMES, 0)  # Reset posisi frame

video_saver = VideoSaver(output_path, frame_width, frame_height, frame_rate)
