...
cap = cv2.VideoCapture("D:/MY_FILES/Videos/cars.mp4")
...
mask = cv2.imread("D:/MY_FILES/Images/mask.png")
...
while True:
    ...
    imgGraphics = cv2.imread("D:/MY_FILES/Images/graphics.png", cv2.IMREAD_UNCHANGED)
    ...
    cv2.putText(img, str(len(totalCount)), (240, 100), cv2.FONT_HERSHEY_PLAIN, 5, (0, 0, 0), 8)
