...
cap = cv2.VideoCapture("../MY_FILES/Videos/CCTV/New/Crop New Video.mp4")

# Initialize YOLO model
model = YOLO(".runs/detect/employees_3_original++/weights/best.pt")
# model = YOLO(".runs/detect/.arc/Employees-2/weights/best.pt")

# Class names
classNames = ["Edo", "Asep", "Rose", "Cica", "Lilis", "Rohani", "Fitri"]

# Dimensions for imshow
scaleof = 0.6  # 0 to 1.5 (1280 x 720 default video resolution)
...
while True:
    ...
    wait_time = max(1, frame_delay - int(processing_time * 4000))  # Ensure non-negative wait time
